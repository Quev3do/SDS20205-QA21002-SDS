...
<body class="flex flex-col flex-wrap justify-space-between h-full w-full">
        ...
        <div class="w-full static flex flex-col gap-1">
            <h4>quevedo@</h4>
            <button><a href="visitantes">Visitantes</a></button>
            <button><a href="registro">Registrar visita</a></button>
            <button><a href="">Dia 1</a></button>
            <button><a href="">Dia 2</a></button>
            <button><a href="">Dia 3</a></button>
            <button><a href="">Dia 4</a></button>
            <button><a href="">Dia 5</a></button>
        </div>
